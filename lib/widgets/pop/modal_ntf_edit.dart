...
Future showModalSheetNFTEdit({
  required BuildContext context,
  required NFTModel ntf,
  ...
  return showCupertinoModalBottomSheet(
    ...
    builder: (context) {
      ...
      context
          .read<NftBloc>()
          .add(ChangeStateImageEvent(file: ntf.productImage));
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () =>
                          context.read<NftBloc>().add(ChooseNFTEvent()),
                      child: Container(
                        height: 320,
                        decoration: BoxDecoration(
